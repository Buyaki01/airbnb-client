const FeaturesSection = ({features, setFeatures}) => {
  const handleFeaturesCheckbox = (e) => {
    const {checked, name} = e.target
    if (checked){
      setFeatures([...features, name])
    }
    else {
      setFeatures([...features.filter(featuresName => featuresName !== name)])
    }
  }
  return(
    <>
      ...
      <div id="features" aria-describedby="features-description" className="grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
        ...
        <label className="flex gap-2 border p-4 rounded-2xl cursor-pointer">
          <input type="checkbox" checked={features.includes('freeParkingSpot')} name='freeParkingSpot' onChange={handleFeaturesCheckbox}/>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <label className="flex gap-2 border p-4 rounded-2xl cursor-pointer">
          <input type="checkbox" checked={features.includes('tv')} name='tv' onChange={handleFeaturesCheckbox}/>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <label className="flex gap-2 border p-4 rounded-2xl cursor-pointer">
          <input type="checkbox" checked={features.includes('cctv')} name='cctv' onChange={handleFeaturesCheckbox}/>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <label className="flex gap-2 border p-4 rounded-2xl cursor-pointer">
          <input type="checkbox" checked={features.includes('privateEntrance')} name='privateEntrance' onChange={handleFeaturesCheckbox}/>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
